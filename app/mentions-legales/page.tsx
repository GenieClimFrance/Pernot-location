function page() {
  return (
    <div className="flex flex-col gap-6 px-20 pb-20 bg-secondary text-white pt-24 font-roboto">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-3">1. Présentation du site</h2>
        <p>
          ...
          utilisateurs du site www.pernotlocation.fr l&apos;identité des
          différents intervenants dans le cadre de sa réalisation et de son
          suivi :
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-1">
          <li>
            <strong>Propriétaire :</strong> SOCIETE PL PERNOT LOCATION - 7 Rue
            Victor Hugo 33185 Le Haillan - 902905363 RCS Bordeaux.
          </li>
          <li>
            <strong>Créateur :</strong> PL
          </li>
          <li>
            <strong>Responsable publication :</strong> PL (personne physique ou
            morale)
          </li>
          <li>
      ...
      <section>
        ...
        <p>
          ...
          www.pernotlocation.fr sont donc invités à les consulter de manière
        ...
        <p className="mt-2">
          ...
          décidée par PL Location qui s&apos;efforcera alors de communiquer
          préalablement aux utilisateurs les dates et heures de
          l&apos;intervention.
        </p>
        <p className="mt-2">
          Le site www.pernotlocation.fr est mis à jour régulièrement par PL
          Location. De la même façon, les mentions légales peuvent être
      ...
      <section>
        ...
        <p>
          Le site www.pernotlocation.fr a pour objet de fournir une information
          concernant l&apos;ensemble des activités de la société.
        </p>
        <p className="mt-2">
          PL Location s&apos;efforce de fournir sur le site
          www.pernotlocation.fr des informations aussi précises que possible.
        ...
        <p className="mt-2">
          Toutes les informations indiquées sur le site www.pernotlocation.fr
          sont données à titre indicatif, et sont susceptibles d&apos;évoluer.
          Par ailleurs, les renseignements figurant sur le site
          www.pernotlocation.fr ont été mis à jour à la dernière date de mise à
          jour indiquée sur le site.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          PL Location est propriétaire des droits de propriété intellectuelle ou
      ...
      <section>
        ...
        <p>
          PL Location ne pourra être tenue responsable des dommages directs et
      ...
      <section>
        ...
        <p className="mt-2">
          À l&apos;occasion de l&apos;utilisation du site www.pernotlocation.fr
          peuvent être recueillies : l&apos;URL des liens par
          l&apos;intermédiaire desquels l&apos;utilisateur a accédé au site, le
          fournisseur d&apos;accès de l&apos;utilisateur, l&apos;adresse de
          protocole Internet (IP) de l&apos;utilisateur.
        </p>
        <p className="mt-2">
          En tout état de cause PL Location ne collecte des informations
        ...
        <p className="mt-2">
          ...
          accompagnée d&apos;une copie du titre d&apos;identité avec signature
          du titulaire de la pièce, en précisant l&apos;adresse à laquelle la
          réponse doit être envoyée.
        </p>
        <p className="mt-2">
          Aucune information personnelle de l&apos;utilisateur du site
          www.pernotlocation.fr n&apos;est publiée à l&apos;insu de
          l&apos;utilisateur, échangée, transférée, cédée ou vendue sur un
          support quelconque à des tiers. Seule l&apos;hypothèse du rachat de PL
          Location et de ses droits permettrait la transmission des dites
          ...
          à vis de l&apos;utilisateur du site www.pernotlocation.fr.
        </p>
        <p className="mt-2">
      ...
      <section>
        ...
        <p>
          ...
          d&apos;autres sites, mis en place avec l&apos;autorisation de PL
          Location. Cependant, PL Location n&apos;a pas la possibilité de
          vérifier le contenu des sites ainsi visités, et n&apos;assumera en
          conséquence aucune responsabilité de ce fait.
        </p>
        <p className="mt-2">
          La navigation sur le site www.pernotlocation.fr est susceptible de
          provoquer l&apos;installation de cookie(s) sur l&apos;ordinateur de
          l&apos;utilisateur. Un cookie est un fichier de petite taille, qui ne
          permet pas l&apos;identification de l&apos;utilisateur, mais qui
          ...
          permettre diverses sur le site, et ont également vocation à permettre
        ...
        <p className="mt-2">
          ...
          L&apos;utilisateur peut toutefois configurer son ordinateur de la
          manière suivante, pour refuser l&apos;installation des cookies :
        </p>
        <ul className="list-disc pl-6 mt-2 space-y-1">
          <li>
            <strong>Sous Internet Explorer :</strong> onglet outil (pictogramme
            en forme de rouage en haut a droite) / options internet. Cliquez sur
      ...
      <section>
        ...
        <p>
          ...
          www.pernotlocation.fr est soumis au droit français. Il est fait
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-3">11. Lexique</h2>
        <p>
